    ...
    init: function (editor) {
        ...
        if (config.showCharCount) {
            ...
            if (config.charLimit != 'unlimited') {
                defaultFormat += '&nbsp;(' + editor.lang.wordcount.limit + '&nbsp;' + config.charLimit + ' chars)';
            }
        }
        ...
        if (config.showWordCount) {
            ...
            if (config.wordLimit != 'unlimited') {
                defaultFormat += '&nbsp;(' + editor.lang.wordcount.limit + '&nbsp;' + config.wordLimit + ' words)';
            }
        }
       ...
       editor.on('dataReady', function(event) {
           ...
           var count = strip(content).trim().split(/\s+/).length;
